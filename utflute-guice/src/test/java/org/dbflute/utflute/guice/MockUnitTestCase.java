...
import org.dbflute.utflute.guice.bean.FooLogic;
import org.dbflute.utflute.guice.bean.FooService;
 ...
 */
public abstract class MockUnitTestCase extends ContainerTestCase {
    ...
    protected List<Module> prepareModuleList() {
        ...
        final Module appModule = new Module() {
            public void configure(Binder binder) {
                ...
                binder.bind(FooController.class).toInstance(new FooControllerImpl());
                binder.bind(FooFacade.class).toInstance(new FooFacade());
                binder.bind(FooLogic.class).toInstance(new FooLogic());
                binder.bind(FooService.class).toInstance(new FooService());
            }
        };
